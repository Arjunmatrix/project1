...
import static Attendence.Attendence.from;
import static Attendence.Attendence.to;
...
//                  Give the image a standard brightness and contrast, in case it was too dark or low contrast.
                ...
                if (faceRect.width() > 0)// Check if a face was detected.
                {
                    ...
                    if (nEigens > 0 && confidence >= MaxConfidence) // Check if the face recognition database is loaded and a person was recognized.
                    {
                        ...
                        String std = arr[1];
                        System.out.println("hello----" + text + "" + std);
                        ...
                        // this.time = Dategetter.getCurrentTime();
                                ...
                                String sy = "p";
                                String query = "INSERT INTO att values('" + text + "','" + DB.Connect.getDate() + "','" + sy + "','"+DB.Connect.getTime()+"')";
                                DB.Connect.stat.executeUpdate(query);
